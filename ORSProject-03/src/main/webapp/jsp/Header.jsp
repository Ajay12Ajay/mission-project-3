...
<body>
	...
	<div class="header">
		...
		<a   class="navbar-brand" href="<%=ORSView.WELCOME_CTL%>">
		     <img src="<%=ORSView.APP_CONTEXT%>/img/custom.png" width="190px" height="50px"></a>
			...
			<ul class="nav navbar-nav ml-auto">
				...
				<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<i class="fa fa-user-tie"></i>My Profile</a> 
						...
						<i class="fa fa-clone"></i>Java	Doc </a>
						<%
							} else {
						%>
						...
						<i class="fa fa-registered"></i> User Registration</a>
					</div></li>
				<%
					}
				%>
